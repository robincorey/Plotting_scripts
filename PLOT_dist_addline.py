...
plt.plot([0, 116], [2.7, 2.7], 'k--', lw=2)
plt.text(106, 2.6, 'EPR', color='black', fontsize=15)
#plt.plot([56, 106], [2.748, 2.748], 'g-', lw=2)
#plt.text(107, 2.84, 'MD', color='green', fontsize=15)
